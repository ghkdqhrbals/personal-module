...
import org.ghkdqhrbals.client.domain.subscribe.entity.SubscribeType
...
data class SubscribeResponse(
    ...
    companion object {
        fun from(subscribe: org.ghkdqhrbals.client.domain.subscribe.entity.Subscribe): SubscribeResponse {
