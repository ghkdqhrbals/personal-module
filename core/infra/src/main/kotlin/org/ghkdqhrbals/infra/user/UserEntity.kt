...
class UserEntity private constructor(
    ...
    companion object {
        fun defUser() = UserEntity(
            name = "no name",
            identity = org.ghkdqhrbals.infra.common.generateKey(),
            password = org.ghkdqhrbals.infra.common.generateKey(),
            phoneNumber = "",
        )
    }
    ...
    var oauthProviderEntities: MutableList<OauthProviderEntity> = mutableListOf()
    @Column(columnDefinition = "DATETIME(6)")
